...
<div id="chat-panel">
		...
		<div id="chat-readonly">
			Чтобы писать в чат нужно пройти авторизацию <a href="https://oauth.vk.com/authorize?client_id=5216648&display=page&redirect_uri=https://api.nay.su/airin/auth&response_type=code">через ВК</a> или <a href="https://t.me/provodach_bot" target="_blank">через Telegram</a>.
		</div>
</div>
